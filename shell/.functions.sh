...
alias mysqltop=watch -n1 'mysql -u tmp_user -p tmp_user_passwd_2102394567 --exec="SHOW PROCESSLIST"'

#function set71() {
#  alias php='/Applications/MAMP/bin/php/php7.1.33/bin/php -c "/Applications/MAMP/bin/php/php7.1.33/conf/php.ini"'
#  export PATH=/Applications/MAMP/bin/php/php7.1.33/bin:$PATH
#}
#
#function set72() {
#  alias php='/Applications/MAMP/bin/php/php7.2.34/bin/php -c "/Applications/MAMP/bin/php/php7.2.34/conf/php.ini"'
#  export PATH=/Applications/MAMP/bin/php/php7.2.34/bin:$PATH
#}
#
#function set73() {
#  alias php='/Applications/MAMP/bin/php/php7.3.24/bin/php -c "/Applications/MAMP/bin/php/php7.3.24/conf/php.ini"'
#  export PATH=/Applications/MAMP/bin/php/php7.3.24/bin:$PATH
#}
#
#function set74() {
#  alias php='/Applications/MAMP/bin/php/php7.4.27/bin/php -c "/Applications/MAMP/bin/php/php7.4.27/conf/php.ini"'
#  export PATH=/Applications/MAMP/bin/php/php7.4.27/bin:$PATH
#}
#
#function set80() {
#  alias php='/Applications/MAMP/bin/php/php8.0.13/bin/php -c "/Applications/MAMP/bin/php/php8.0.13/conf/php.ini"'
#  export PATH=/Applications/MAMP/bin/php/php8.0.13/bin:$PATH
#}
#
#function set81() {
